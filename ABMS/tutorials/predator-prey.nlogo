...
to move
 rt random 180  ; Turn right at random degrees
 fd 1
...
to eat-grass
  ...
  if grass-amount >= energy-from-grass [
...
"pen-1" 1.0 0 -8053223 true "" "plot (count wolves) * 10"
"pen-2" 1.0 0 -7500403 true "" "plot (sum [grass-amount] of patches) / 10"
